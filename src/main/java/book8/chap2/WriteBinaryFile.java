...
public class WriteBinaryFile {
    ...
    public static void main(String[] args) {
        ...
        DataOutputStream out = openOutputStream("C:\\Users\\user1\\Documents\\CodeCollegeZA\\BootCamp_2023\\Java_All_In_One\\cousrework\\src\\main.java.book8\\chap2\\movies2.dat");
        for (Movie m : movies) {
            writeMovie(m, out);
        }
        closeFile(out);
